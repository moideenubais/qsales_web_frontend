...
const TopBar = ({ switchLanguage }) => {
  ...
  return (
    <div
      id="top-bar"
      className="w-100 py-1 px-3 bg-dark  d-flex flex-row justify-content-between align-items-center flex-wrap"
    >
      <span className="text-white flex-1 orders-2 d-flex flex-row align-items-center ">
        <img
          alt="call"
      ...
      <div class="ticker-wrap text-white flex-2">
        ...
        <div class="ticker__item">
          {" "}
          FREE DELIVERY FOR ORDERS ABOVE QR 35 | DELIVERY IN 24 HRS ALL OVER
          QATAR
        </div>
