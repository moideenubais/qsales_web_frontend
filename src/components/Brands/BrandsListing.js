...
const BrandsListing = (props) => {
  ...
  let Categories = categories?.map((catagory) => ({
    label: catagory.i18nResourceBundle.name,
    value: catagory._id,
  }));
      ...
      <div className="col-12 col-sm-12 col-md-12 col-lg-12">
        <div className="col-12 col-sm-12 col-md-12 col-lg-12 pt-4 ">
          <h4 className="p-0 m-0">
            {brands?.find((b) => b._id == brandId)?.i18nResourceBundle?.name}
          </h4>
          <p className="p-0 m-0">{`${info?.totalNumber || 0} Results for ${
            brands?.find((b) => b._id == brandId)?.i18nResourceBundle?.name
          }`}</p>
